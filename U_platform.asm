...
;U_platform.c,13 :: 		void delayHandler(uint32_t time, void (*HandleF)(void))
;U_platform.c,16 :: 		uint32_t totalDelay = now + time;
...
;U_platform.c,17 :: 		while (u_systemTick < totalDelay)
L_delayHandler0:
