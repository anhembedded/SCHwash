...
;schWash_main.c,13 :: 		void Interrupt()
;schWash_main.c,16 :: 		if (TMR1IF_bit)
	BTFSS      TMR1IF_bit+0, BitPos(TMR1IF_bit+0)
	GOTO       L_Interrupt0
;schWash_main.c,18 :: 		TMR1IF_bit = 0;
	BCF        TMR1IF_bit+0, BitPos(TMR1IF_bit+0)
;schWash_main.c,19 :: 		TMR1H = 0xFCU;
	MOVLW      252
	MOVWF      TMR1H+0
;schWash_main.c,20 :: 		TMR1L = 0x18U;
	MOVLW      24
	MOVWF      TMR1L+0
;schWash_main.c,21 :: 		PF_systemTick++;
...
;schWash_main.c,22 :: 		}
L_Interrupt0:
;schWash_main.c,24 :: 		if (U_IS_SET_EXTERNAL_INTERRUPT())
	MOVF       INTCON+0, 0
	ANDLW      2
	MOVWF      R0+0
	MOVLW      0
	...
	BTFSC      STATUS+0, 2
	GOTO       L_Interrupt1
;schWash_main.c,26 :: 		CLEAR_BIT(U_VAN_PORT, U_VAN_PIN);
	MOVLW      247
	ANDWF      PORTA+0, 1
;schWash_main.c,27 :: 		UHAL_TIMER2_ON();
	BSF        T2CON+0, 2
;schWash_main.c,28 :: 		U_CLEAR_EXTERNAL_INTERRUPT();
	MOVLW      253
	ANDWF      INTCON+0, 1
;schWash_main.c,29 :: 		}
L_Interrupt1:
;schWash_main.c,30 :: 		if (UHAL_TIMER2_IS_ISR_FLAG_SET())
	MOVF       PIR1+0, 0
	ANDLW      2
	MOVWF      R0+0
	MOVLW      0
	...
	BTFSC      STATUS+0, 2
	GOTO       L_Interrupt2
;schWash_main.c,32 :: 		SET_BIT(U_VAN_PORT, U_VAN_PIN);
	BSF        PORTA+0, 3
;schWash_main.c,33 :: 		U_TIMER2_COMPARE_REG = timerPrBuffer;
	MOVF       schWash_main_timerPrBuffer+0, 0
	MOVWF      PR2+0
;schWash_main.c,34 :: 		UHAL_TIMER2_OFF();
	MOVLW      251
	ANDWF      T2CON+0, 1
;schWash_main.c,35 :: 		UHAL_TIMER2_CLEAR_ISR_FLAG();
	MOVLW      253
	ANDWF      PIR1+0, 1
;schWash_main.c,36 :: 		}
L_Interrupt2:
...
;schWash_main.c,42 :: 		void main()
;schWash_main.c,45 :: 		U_gpioInit();
	CALL       _U_gpioInit+0
;schWash_main.c,46 :: 		UAPI_MOTOR_init();
	CALL       _UAPI_MOTOR_init+0
;schWash_main.c,47 :: 		InitTimer1();
	CALL       _InitTimer1+0
;schWash_main.c,49 :: 		while (1)
L_main3:
;schWash_main.c,51 :: 		if(UAPI_buttonHanlde() == UAPI_NUT1_IS_PRESSED)
	CALL       _UAPI_buttonHanlde+0
	MOVF       R0+0, 0
	XORLW      1
	BTFSS      STATUS+0, 2
	GOTO       L_main5
;schWash_main.c,53 :: 		ledNum1 = 1;
	MOVLW      1
	MOVWF      schWash_main_ledNum1+0
	MOVLW      0
	MOVWF      schWash_main_ledNum1+1
;schWash_main.c,54 :: 		UAPI_MOTOR_start();
	CALL       _UAPI_MOTOR_start+0
;schWash_main.c,55 :: 		}
L_main5:
;schWash_main.c,56 :: 		if(UAPI_buttonHanlde() == UAPI_NUT2_IS_PRESSED)
	CALL       _UAPI_buttonHanlde+0
	MOVF       R0+0, 0
	XORLW      2
	BTFSS      STATUS+0, 2
	GOTO       L_main6
;schWash_main.c,58 :: 		ledNum1 = 2;
	MOVLW      2
	MOVWF      schWash_main_ledNum1+0
	MOVLW      0
	MOVWF      schWash_main_ledNum1+1
;schWash_main.c,59 :: 		UAPI_MOTOR_stop();
	CALL       _UAPI_MOTOR_stop+0
;schWash_main.c,60 :: 		}
L_main6:
;schWash_main.c,61 :: 		if(UAPI_buttonHanlde() == UAPI_NUT3_IS_PRESSED)
	CALL       _UAPI_buttonHanlde+0
	MOVF       R0+0, 0
	XORLW      4
	BTFSS      STATUS+0, 2
	GOTO       L_main7
;schWash_main.c,63 :: 		ledNum1 = 3;
	MOVLW      3
	MOVWF      schWash_main_ledNum1+0
	MOVLW      0
	MOVWF      schWash_main_ledNum1+1
...
;schWash_main.c,68 :: 		}
L_main8:
;schWash_main.c,69 :: 		UAPI_MOTOR_setSpeed(123, &timerPrBuffer);
	MOVLW      123
...
;schWash_main.c,76 :: 		void ledDisplayHandler()
;schWash_main.c,78 :: 		seg7Print(ledNum1, ledNum2);
...
;schWash_main.c,81 :: 		void delayHandler(uint32_t time, void (*HandleF)(void))
;schWash_main.c,85 :: 		uint32_t totalDelay = now + time;
	MOVF       _PF_systemTick+0, 0
...
;schWash_main.c,86 :: 		while (PF_systemTick < totalDelay)
L_delayHandler9:
	MOVF       delayHandler_totalDelay_L0+3, 0
	SUBWF      _PF_systemTick+3, 0
	BTFSS      STATUS+0, 2
	GOTO       L__delayHandler22
...
L__delayHandler22:
	BTFSC      STATUS+0, 0
	GOTO       L_delayHandler10
;schWash_main.c,88 :: 		HandleF();
